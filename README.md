...
```shell
go get github.com/freqai/go-binance/v2
```

For v1 API, it has been moved to `v1` branch, please use:

```shell
go get github.com/freqai/go-binance/v1
```
...
```golang
import (
    "github.com/freqai/go-binance/v2"
)
```
...
```go
import (
    "github.com/freqai/go-binance/v2/futures"
)
...
```go
import (
    "github.com/freqai/go-binance/v2/delivery"
)
